package com.wk.content.controller;

import com.github.pagehelper.PageInfo;
import com.wk.content.pojo.Content;
import com.wk.content.service.ContentService;
...
public class ContentController {
    ...
    public Result<List<Content>> findByCategory(@PathVariable(name = "id") Long id){
        return new Result<>(true,StatusCode.OK,"查询广告集合成功",contentService.findByCategory(id));
    }
