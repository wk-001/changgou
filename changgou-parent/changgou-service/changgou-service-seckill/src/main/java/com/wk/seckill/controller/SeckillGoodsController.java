...
public class SeckillGoodsController {
     ...
     */
    @GetMapping("one")
    public Result<SeckillGoods> getByRedis(String time,Long goodsId){
        return new Result<>(true,StatusCode.OK,"秒杀商品详情查询成功！", seckillGoodsService.getByRedis(time,goodsId));
    }
    ...
    public Result<List<Date>> menus(){
        return new Result<>(true,StatusCode.OK,"秒杀商品活动的时间段查询成功！", DateUtil.getDateMenus());
    }
    ...
    public Result<List<SeckillGoods>> list(String time){
        return new Result<List<SeckillGoods>>(true,StatusCode.OK,"秒杀商品列表查询成功！",seckillGoodsService.list(time));
    }
